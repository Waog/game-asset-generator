...
public class GoogleAuthCodeForTokenExchanger {
	...
	public static class GetCredentialsException extends Exception {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 3411829755384475936L;
	...
	public static class CodeExchangeException extends GetCredentialsException {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 997501774850890766L;
	...
	public static class NoRefreshTokenException extends GetCredentialsException {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -4875423563764530242L;
	...
	private static class NoUserIdException extends Exception {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -2517881110754229301L;
	}
	...
	static Credential getStoredCredentials(String userId) {
		return credentialsDatabaseStub.get(userId);
	}
	...
	static void storeCredentials(String userId, Credential credentials) {
		credentialsDatabaseStub.put(userId, credentials);
	}
	...
	static GoogleAuthorizationCodeFlow getFlow() throws IOException {
		if (flow == null) {
			...
			GoogleClientSecrets clientSecrets = Client.getSecrets();
			JsonFactory jsonFactory = clientSecrets.getFactory();
